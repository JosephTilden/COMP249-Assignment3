...
public class TradeRequest {
    ...
    public String toString() {
        return String.format("Request %s from %s to %s: %s, worth $%.2f with %.2f a percent Tariff", requestID, originCountry, destinationCountry, productCategory, tradeValue, proposedTariff);
    }
}
